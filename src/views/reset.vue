  ...
  <div class="reset">
    ...
    <div class="content">
      ...
      <div class="contentItem">
        ...
        <div class="itemContent">
          <div class="confirmBtn" @click='confirmReset'>
            重置密码
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    sendCode() {
      if(isPoneAvailable(this.regData.phone) && checkLength(this.regData.password, 6, 15)) {
        this.locking = true

        http.post('/frontend/sms/send', {
    ...
    confirmReset() {
      if(isPoneAvailable(this.regData.phone) && checkLength(this.regData.password, 6, 15) && checkLength(this.regData.code,6,6)){
        http.postLoading('/frontend/user/forgotPassword',this.regData)
        .then((res) => {
          console.log(res)
